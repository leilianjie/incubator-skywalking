...
public class WorkerIdDefine {
	...
	public static final int CONN_POOL_METRIC_BRIDGE_NODE_ID = 3500;
	public static final int CONN_POOL_MINUTE_METRIC_PERSISTENCE_WORKER_ID = 3502;
	public static final int CONN_POOL_HOUR_METRIC_PERSISTENCE_WORKER_ID = 3504;
	public static final int CONN_POOL_HOUR_METRIC_TRANSFORM_NODE_ID = 3505;
	public static final int CONN_POOL_DAY_METRIC_PERSISTENCE_WORKER_ID = 3506;
	public static final int CONN_POOL_DAY_METRIC_TRANSFORM_NODE_ID = 3507;
	public static final int CONN_POOL_MONTH_METRIC_PERSISTENCE_WORKER_ID = 3508;
	public static final int CONN_POOL_MONTH_METRIC_TRANSFORM_NODE_ID = 3509;
	
	public static final int THREAD_POOL_METRIC_BRIDGE_NODE_ID = 3600;
	public static final int THREAD_POOL_MINUTE_METRIC_PERSISTENCE_WORKER_ID = 3602;
	public static final int THREAD_POOL_HOUR_METRIC_PERSISTENCE_WORKER_ID = 3604;
	public static final int THREAD_POOL_HOUR_METRIC_TRANSFORM_NODE_ID = 3605;
	public static final int THREAD_POOL_DAY_METRIC_PERSISTENCE_WORKER_ID = 3606;
	public static final int THREAD_POOL_DAY_METRIC_TRANSFORM_NODE_ID = 3607;
	public static final int THREAD_POOL_MONTH_METRIC_PERSISTENCE_WORKER_ID = 3608;
	public static final int THREAD_POOL_MONTH_METRIC_TRANSFORM_NODE_ID = 3609;
}
