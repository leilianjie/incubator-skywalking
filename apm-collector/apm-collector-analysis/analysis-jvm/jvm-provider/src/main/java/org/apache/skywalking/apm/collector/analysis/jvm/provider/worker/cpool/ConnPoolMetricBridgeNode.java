 ...
 */
public class ConnPoolMetricBridgeNode implements NodeProcessor<ConnPoolMetric, ConnPoolMetric> {

    @Override public int id() {
        return WorkerIdDefine.CONN_POOL_METRIC_BRIDGE_NODE_ID;
    }

    @Override public void process(ConnPoolMetric metric, Next<ConnPoolMetric> next) {
        next.execute(metric);
    }
}
