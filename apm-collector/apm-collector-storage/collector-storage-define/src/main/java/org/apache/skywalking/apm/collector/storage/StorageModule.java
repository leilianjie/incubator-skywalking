...
public class StorageModule extends ModuleDefine {
    ...
    private void addPersistenceDAO(List<Class> classes) {
        ...
        classes.add(IThreadPoolMinuteMetricPersistenceDAO.class);
        classes.add(IThreadPoolHourMetricPersistenceDAO.class);
        classes.add(IThreadPoolDayMetricPersistenceDAO.class);
        classes.add(IThreadPoolMonthMetricPersistenceDAO.class);

        classes.add(IConnPoolMinuteMetricPersistenceDAO.class);
        classes.add(IConnPoolHourMetricPersistenceDAO.class);
        classes.add(IConnPoolDayMetricPersistenceDAO.class);
        classes.add(IConnPoolMonthMetricPersistenceDAO.class);
