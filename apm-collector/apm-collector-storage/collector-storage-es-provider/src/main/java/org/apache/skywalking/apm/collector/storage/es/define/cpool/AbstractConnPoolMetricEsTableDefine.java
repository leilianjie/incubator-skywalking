...
package org.apache.skywalking.apm.collector.storage.es.define.cpool;
 ...
 */
public abstract class AbstractConnPoolMetricEsTableDefine extends ElasticSearchTableDefine {

    AbstractConnPoolMetricEsTableDefine(String name) {
        super(name);
    }
    ...
    @Override public final void initialize() {
        ...
        addColumn(new ElasticSearchColumnDefine(ConnPoolMetricTable.TIMES, ElasticSearchColumnDefine.Type.Long.name()));
        addColumn(new ElasticSearchColumnDefine(ConnPoolMetricTable.TIME_BUCKET, ElasticSearchColumnDefine.Type.Long.name()));
    }
}
