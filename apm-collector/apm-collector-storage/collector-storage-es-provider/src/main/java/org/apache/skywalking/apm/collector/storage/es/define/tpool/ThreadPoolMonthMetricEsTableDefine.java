 ...
 */
public class ThreadPoolMonthMetricEsTableDefine extends AbstractThreadPoolMetricEsTableDefine {

    public ThreadPoolMonthMetricEsTableDefine() {
        super(ThreadPoolMetricTable.TABLE + Const.ID_SPLIT + TimePyramid.Month.getName());
    }
