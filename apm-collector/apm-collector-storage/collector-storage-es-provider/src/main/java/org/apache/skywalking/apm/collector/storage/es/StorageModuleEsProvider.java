...
import org.apache.skywalking.apm.collector.storage.es.dao.ServiceNameHeartBeatEsPersistenceDAO;
...
import org.apache.skywalking.apm.collector.storage.es.dao.cpool.ConnPoolDayMetricEsPersistenceDAO;
import org.apache.skywalking.apm.collector.storage.es.dao.cpool.ConnPoolHourMetricEsPersistenceDAO;
import org.apache.skywalking.apm.collector.storage.es.dao.cpool.ConnPoolMinuteMetricEsPersistenceDAO;
import org.apache.skywalking.apm.collector.storage.es.dao.cpool.ConnPoolMonthMetricEsPersistenceDAO;
...
import org.apache.skywalking.apm.collector.storage.es.dao.tpool.ThreadPoolDayMetricEsPersistenceDAO;
import org.apache.skywalking.apm.collector.storage.es.dao.tpool.ThreadPoolHourMetricEsPersistenceDAO;
import org.apache.skywalking.apm.collector.storage.es.dao.tpool.ThreadPoolMinuteMetricEsPersistenceDAO;
import org.apache.skywalking.apm.collector.storage.es.dao.tpool.ThreadPoolMonthMetricEsPersistenceDAO;
...
import org.apache.skywalking.apm.collector.storage.es.dao.ui.ConnPoolMetricUIDAO;
...
import org.apache.skywalking.apm.collector.storage.es.dao.ui.ThreadPoolMetricUIDAO;
...
public class StorageModuleEsProvider extends ModuleProvider {
    ...
    private void registerPersistenceDAO() throws ServiceNotProvidedException {
        ...
        this.registerServiceImplementation(IConnPoolMinuteMetricPersistenceDAO.class, new ConnPoolMinuteMetricEsPersistenceDAO(elasticSearchClient));
        this.registerServiceImplementation(IConnPoolHourMetricPersistenceDAO.class, new ConnPoolHourMetricEsPersistenceDAO(elasticSearchClient));
        this.registerServiceImplementation(IConnPoolDayMetricPersistenceDAO.class, new ConnPoolDayMetricEsPersistenceDAO(elasticSearchClient));
        this.registerServiceImplementation(IConnPoolMonthMetricPersistenceDAO.class, new ConnPoolMonthMetricEsPersistenceDAO(elasticSearchClient));
        
        this.registerServiceImplementation(IThreadPoolMinuteMetricPersistenceDAO.class, new ThreadPoolMinuteMetricEsPersistenceDAO(elasticSearchClient));
        this.registerServiceImplementation(IThreadPoolHourMetricPersistenceDAO.class, new ThreadPoolHourMetricEsPersistenceDAO(elasticSearchClient));
        this.registerServiceImplementation(IThreadPoolDayMetricPersistenceDAO.class, new ThreadPoolDayMetricEsPersistenceDAO(elasticSearchClient));
        this.registerServiceImplementation(IThreadPoolMonthMetricPersistenceDAO.class, new ThreadPoolMonthMetricEsPersistenceDAO(elasticSearchClient));
    ...
    private void registerUiDAO() throws ServiceNotProvidedException {
        ...
        this.registerServiceImplementation(IConnPoolMetricUIDAO.class, new ConnPoolMetricUIDAO(elasticSearchClient));
        this.registerServiceImplementation(IThreadPoolMetricUIDAO.class, new ThreadPoolMetricUIDAO(elasticSearchClient));
    }
