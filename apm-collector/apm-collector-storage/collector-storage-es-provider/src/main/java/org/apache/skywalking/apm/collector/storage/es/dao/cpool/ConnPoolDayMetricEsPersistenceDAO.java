 ...
 */
public class ConnPoolDayMetricEsPersistenceDAO extends AbstractConnPoolMetricEsPersistenceDAO implements IConnPoolDayMetricPersistenceDAO<IndexRequestBuilder, UpdateRequestBuilder, ConnPoolMetric> {

    public ConnPoolDayMetricEsPersistenceDAO(ElasticSearchClient client) {
        super(client);
    }
