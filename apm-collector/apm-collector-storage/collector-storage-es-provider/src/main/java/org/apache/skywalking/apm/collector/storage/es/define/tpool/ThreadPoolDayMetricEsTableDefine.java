 ...
 */
public class ThreadPoolDayMetricEsTableDefine extends AbstractThreadPoolMetricEsTableDefine {

    public ThreadPoolDayMetricEsTableDefine() {
        super(ThreadPoolMetricTable.TABLE + Const.ID_SPLIT + TimePyramid.Day.getName());
    }
